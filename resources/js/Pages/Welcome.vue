...
<template>
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                    ...
                    <!-- 1. Ang GIF (Background) -->
                    <img
                        src="enearscene.gif"
                        alt="Background"
                        class="absolute inset-0 h-full w-full object-cover"
                    >
                    <div class="absolute inset-0 z-0 bg-[radial-gradient(circle,_transparent_20%,_black_90%)] opacity-80"></div>

                    <!-- 2. Ang Dark Overlay (Brightness control) -->
                    <!-- Pwede mong palitan ang opacity (bg-black/50, /70, etc.) para sa dilim na gusto mo -->
